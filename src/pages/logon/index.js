                ...
                <div className="container main-container">
                    <div className="row no-gutters">
                        ...
                        <div className="col-lg-6 col-md-6 px-5 pt-5">
                            <h1 className="font-weight-bold py-3"><img src={logoImg} className="img-fluid" alt="" /></h1>
                            <br />
                            ...
                            >
                                ...
                                <div className="form-row" style={{display:this.state.loginErro}}>
                                    <div className="col-lg-10">
                                        <br />
                                    <div className="alert alert-warning alert-dismissible fade show" role="alert">
                                        <strong>Ooops!</strong>{this.state.loginErroMsg} <a href="/auth/recuperar-senha">Recuperar senha</a>
                                        <button type="button" onClick={() => this.setState({loginErroMsg:"",loginErro:"none" })} className="close"  aria-label="Close">
                                ...
                                <div className="form-row">
                                    <div className="col-lg-10">
                                        <button onClick ={(e) => this.handleLogin(e)}  type="submit" className="btn1 mt-3 mb-1">Logar</button>
                                    </div>
                                </div>
                                <div className="form-row">
                                    <div className="col-lg-10">
                                        <button type="button" className="btn2 mb-3"><i className="fab fa-google mr-2"></i>Logar com o Google</button>
                                    </div>
                                </div>
