...
class SwitchLayout extends React.Component {
    ...
    handleSwitchToAdminLayout= () => AuthService.Logout()
    .then( () =>{
        this.props.history.push('/auth')
    });

    render(){
        return(<div className="w-10 order-4 dual-collapse2">
                ...
                <li className="nav-item dropdown">
                    <div className="row">
                        <div className="col col-md-12">
                            <a className="nav-link dropdown-toggle" href="/#" id="layoutDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <div className="row">
                                    <div className="col col-md-12">
                            ...
                            <div className="dropdown-menu dropdown-menu-right" aria-labelledby="layoutDropdown">
                                ...
                                <a className="dropdown-item" href="/admin">
                                    <div className="row">
                                        <div className="col col-md-2"><i className="fa fa-user-cog"></i></div>
